  ...
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-shell">
        {/* The film leads: full width, and wider than tall on big screens so
            the headline underneath is still in view. */}
        <div data-delay="0" className="reveal">
          <VideoPlaceholder
            poster="/images/gallery/2026-06-20/02.jpg"
        ...
        <div className="mx-auto mt-10 max-w-[760px] text-center sm:mt-12">
          ...
          <h1
            data-delay="0.12"
            className="reveal text-[34px] font-extrabold leading-[1.1] tracking-[-0.03em] sm:text-[46px] md:text-[60px]"
          >
            What is{" "}
          ...
          <p
            data-delay="0.18"
            className="reveal mx-auto mt-5 max-w-[560px] text-[16px] leading-[1.7] text-muted sm:text-[18px]"
          >
          ...
          <div
            data-delay="0.24"
            className="reveal mx-auto mt-8 grid max-w-[420px] grid-cols-1 gap-2.5 sm:flex sm:max-w-none sm:justify-center sm:gap-3"
          >
            <a
              href="#events"
