...
export default function EventCard({ event, variant = "upcoming" }) {
  ...
  return (
    <div
      data-stagger
      className="reveal clay group flex flex-col overflow-hidden rounded-card bg-white transition-[opacity,translate,box-shadow] duration-300 hover:shadow-lg"
    >
      ...
      <div className="flex flex-1 flex-col p-5">
        ...
        <Link
          ...
          className={
            isUpcoming
              ? "mt-4 block rounded-btn bg-ink p-3 text-center text-sm font-bold text-white transition-colors duration-300 hover:bg-accent hover:text-white"
